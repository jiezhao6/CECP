...
def load_data(path_data, dataset, scale):
    ...
    if dataset=='cail':
        ...
        if True:
            ...
            path_elements = path_data + 'elements_cail_small.pkl'
            with open(path_elements, 'rb') as f:
                data = pickle.load(f)
            r.update({'elements':data})
...
def get_train_test_val_data(dataset, scale, config):
...
def get_train_parameters(args, config):
    ...
    path_save_models = {}
    path_save_models['encoder'] = '../ckpt/' + dataset + '_' + scale + '_encoder_epoch_'
    path_save_models['prednet'] = '../ckpt/' + dataset + '_' + scale + '_prednet_epoch_'
    path_save_models['glagent'] = '../ckpt/' + dataset + '_' + scale + '_glagent_epoch_'
    path_save_models['optenpr'] = '../ckpt/' + dataset + '_' + scale + '_optenpr_epoch_'
    path_save_models['optglag'] = '../ckpt/' + dataset + '_' + scale + '_optglag_epoch_'
