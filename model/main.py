...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='criminal')
    parser.add_argument('--scale', type=str, default='small')
    parser.add_argument('--nclass', type=int, default=149)
    ...
    path_word_embedding_data = '../data/processed_data/word_embedding_data.pkl'
